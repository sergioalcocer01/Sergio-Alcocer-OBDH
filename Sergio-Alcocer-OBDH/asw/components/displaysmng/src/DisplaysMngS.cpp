...
DisplaysMng::DisplaysMng(TEDROOMComponentID id,
...
void DisplaysMng::EDROOMBehaviour()
{
...
bool DisplaysMng::EDROOMIsComponentFinished()
{
...
void DisplaysMng::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,
