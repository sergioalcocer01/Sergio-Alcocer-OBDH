#ifndef DISPLAYSMNG_H_
#define DISPLAYSMNG_H_
 ...
 *
 */
class DisplaysMng: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMDisplaysMngSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMDisplaysMngSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SDisplaysStart, 
							SIncreaseDisplays, 
							SDisplaysReady };
	...
	/**
	 * \class DisplaysMng::CEDROOMMemory
	...
	//! Constructor
	DisplaysMng(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMDisplaysMngSignal { EDROOMSignalTimeout,
		...
		friend class DisplaysMng;

		//!component reference
		DisplaysMng &EDROOMcomponent;
		...
		//!Constructor
		EDROOM_CTX_Top_0 (DisplaysMng &act,
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (DisplaysMng &act );
