 ...
 *
 */
class LEDMng: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMLEDMngSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMLEDMngSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SLEDStart, 
							SToggleLEDShift, 
							SLEDReady, 
	...
	//! Constructor
	LEDMng(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
